...
def index(request):
    ...
    enrollments = Enrollment.objects.prefetch_related('course').filter(registration__student__user=user, registration__cohort__status=Cohort.StatusChoices.ACTIVE)
